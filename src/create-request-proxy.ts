...
type RequestProxy<T, U extends Json | StructuredClone = Json> = {
  [P in FunctionKeys<T>]:
...
export function createRequestProxy<T extends object, U extends Json | StructuredClone = Json>(obj: T, createId: () => string): RequestProxy<T, U> {
